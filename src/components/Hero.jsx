    ...
    <section id="home" className="pt-28 lg:pt-36">
      <div className="container lg:grid lg:grid-cols-2 items-center lg:gap-10">
        <div>
          ...
          <h2 className="text-xl sm:text-2xl font-medium text-purple-500 tracking-wide mb-8">Student of Polytechnic State of Banjarmasin, Software Engineering Department.</h2>
          <div className="flex items-center gap-3">
        ...
        <div className="hidden lg:block">
          <figure className="w-full max-w-[480px] ml-auto bg-gradient-to-t from-sky-400 via-25% via-sky-400/40 to-65% rounded-[60px] overflow-hidden">
            <img src="/img/lala.jpeg" alt="lala" width={656} height={800} className="w-full" />
          </figure>
        </div>
      </div>
    </section>

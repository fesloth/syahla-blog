...
const Contact = () => {
  return (
    <section id="contact" className="section">
      ...
      <form 
      action="https://getform.io/f/blllzojb" 
      method="POST"
      ...
      >
            ...
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                <div className="mb-4">
                    ...
                    <input type="text" name="name" id="name" autoComplete="name" placeholder="Syahla Nur Azizah" required className="text-field"/>
                </div>
                <div className="mb-4">
                    <label 
                    htmlFor="email"
                    ...
                    <input type="email" name="email" id="email" autoComplete="email" placeholder="syahlanr2089@gmail.com" required className="text-field"/>
                </div>
                <div className="mb-4">
                    <label 
                    htmlFor="message"
